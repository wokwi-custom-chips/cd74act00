...
If you want to make changes to the test project firmware, edit [test/logic/logic.ino](test/update/logic.ino), and then run `make test` to rebuild the .hex file. You'll need the [arduino-cli](https://arduino.github.io/arduino-cli/latest/installation/), which is already installed in the dev container.
